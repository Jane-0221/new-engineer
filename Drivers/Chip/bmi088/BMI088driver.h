...
#define BMI088_TEMP_OFFSET 23.0f //23 
...
#define BMI088_LONG_DELAY_TIME 1 //80 changed by sethome
...
typedef PACKED_STRUCT(BMI088_RAW_DATA) 
{
    uint8_t status;
    int16_t accel[3];
    int16_t temp;
...
typedef PACKED_STRUCT(BMI088_REAL_DATA) 
{
    uint8_t status;
    fp32 accel[3];
    fp32 temp;
